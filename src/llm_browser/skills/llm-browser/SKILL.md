...
(Reddit, X, Hacker News, LinkedIn, Trustpilot, G2, Threads, Quora, Stomp, Lowyat (`forum.lowyat.net`), Facebook, Instagram, Discourse, XenForo (e.g.
`forums.hardwarezone.com.sg`), and any page with
